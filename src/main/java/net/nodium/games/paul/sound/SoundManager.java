...
public class SoundManager {
    ...
    private void addAllSoundSources() {
//        addSoundSource("entities.oofcube.oof", new SoundSource(false));
    }
    ...
    public void updateListenerPosition(Camera camera) {
        ...
        cameraMatrix = MathUtils.createViewMatrix(camera);

        listener.setPosition(camera.pos);
